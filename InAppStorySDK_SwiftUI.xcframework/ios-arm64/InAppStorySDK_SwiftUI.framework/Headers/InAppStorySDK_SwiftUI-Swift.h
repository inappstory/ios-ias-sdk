...
#ifndef INAPPSTORYSDK_SWIFTUI_SWIFT_H
#define INAPPSTORYSDK_SWIFTUI_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="InAppStorySDK_SwiftUI",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC21InAppStorySDK_SwiftUI25CSPhoneFormattedTextField")
...
SWIFT_CLASS("_TtC21InAppStorySDK_SwiftUI15CustomGoodsView")
...
SWIFT_CLASS("_TtC21InAppStorySDK_SwiftUI19DownloadPlaceholder")
...
SWIFT_PROTOCOL("_TtP21InAppStorySDK_SwiftUI25LottiePlaceholderProtocol_")
...
@interface DownloadPlaceholder (SWIFT_EXTENSION(InAppStorySDK_SwiftUI)) <LottiePlaceholderProtocol>
- (void)setAnimationData:(NSData * _Nullable)data;
- (void)setMinTime:(NSInteger)time;
- (void)finishAnimationWith:(void (^ _Nonnull)(void))complete;
- (void)resetProgress;
...
SWIFT_PROTOCOL("_TtP21InAppStorySDK_SwiftUI22EditorDownloadProtocol_")
@protocol EditorDownloadProtocol
+ (void)cancel;
@end


SWIFT_CLASS("_TtC21InAppStorySDK_SwiftUI21EditorDownloadService")
...
@interface EditorDownloadService (SWIFT_EXTENSION(InAppStorySDK_SwiftUI)) <NSURLSessionDataDelegate>
...
SWIFT_CLASS("_TtC21InAppStorySDK_SwiftUI10GoodObject")
...
///   </li>
/// </ul>
SWIFT_CLASS("_TtC21InAppStorySDK_SwiftUI19IASVideoPlayerLayer")
...
SWIFT_CLASS("_TtC21InAppStorySDK_SwiftUI10InAppStory")
