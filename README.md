...
```ruby
use_frameworks!
pod 'InAppStory', :git => 'https://github.com/inappstory/ios-sdk.git', :tag => '1.18.1'
```
...
```ogdl
github "inappstory/ios-sdk" ~> 1.18.1
```
...
```swift
dependencies: [
    .package(url: "https://github.com/inappstory/ios-sdk.git", .upToNextMajor(from: "1.18.1"))
]
```
