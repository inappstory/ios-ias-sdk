...
```ruby
use_frameworks!
pod 'InAppStory_UGC', :git => 'https://github.com/inappstory/ios-sdk.git', :tag => '1.17.0-UGC'
```
...
```ogdl
github "inappstory/ios-sdk" ~> 1.17.0-UGC
```
...
```swift
dependencies: [
    .package(url: "https://github.com/inappstory/ios-sdk.git", .upToNextMajor(from: "1.17.0-UGC"))
]
```
