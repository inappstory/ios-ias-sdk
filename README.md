...
```ruby
use_frameworks!
pod 'InAppStory_UGC', :git => 'https://github.com/inappstory/ios-sdk.git', :tag => '1.16.1-UGC'
```
...
```ogdl
github "inappstory/ios-sdk" ~> 1.16.1-UGC
```
...
```swift
dependencies: [
    .package(url: "https://github.com/inappstory/ios-sdk.git", .upToNextMajor(from: "1.16.1-UGC"))
]
```
...
* `StoryWidgetEvent` - action in widget with parameters:
    ...
    * `data<Dictionary<String, Any>?>` - activated widget data [detail data fields](https://github.com/inappstory/ios-sdk/blob/UGC/Docs/StoryWidgetEvent.md);
