...
```ruby
use_frameworks!
pod 'InAppStory', :git => 'https://github.com/inappstory/ios-sdk.git', :tag => '1.20.3'
```
...
```ogdl
github "inappstory/ios-sdk" ~> 1.20.3
```
...
```swift
dependencies: [
    .package(url: "https://github.com/inappstory/ios-sdk.git", .upToNextMajor(from: "1.20.3"))
]
```
