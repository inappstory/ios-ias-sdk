...
# UIKit
use_frameworks!
pod 'InAppStory', :git => 'https://github.com/inappstory/ios-ias-sdk.git', :tag => '1.26.0-RC9'
```
...
5. Set "*Dependecy rule*" to "*Exact Version*" and set *"1.26.0-RC9"*;
...
- deployment target rollback (UIKit - 11.0, SwiftUI - 13.4);
