...
```ruby
use_frameworks!
pod 'InAppStory_SwiftUI', :git => 'https://github.com/inappstory/ios-sdk.git', :tag => '1.19.9-SwiftUI'
```
...
```ogdl
github "inappstory/ios-sdk" ~> 1.19.9-SwiftUI
```
...
```swift
dependencies: [
    .package(url: "https://github.com/inappstory/ios-sdk.git", .upToNextMajor(from: "1.19.9-SwiftUI"))
]
```
