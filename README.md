...
* [Objects](https://github.com/inappstory/ios-sdk#Objects)
	...
	* [EditorCellSettings](https://github.com/inappstory/ios-sdk#EditorCellSettings)
...
```ruby
use_frameworks!
pod 'InAppStory', :git => 'https://github.com/inappstory/ios-sdk.git', :tag => '1.21.1'
```
...
```ogdl
github "inappstory/ios-sdk" ~> 1.21.1
```
...
```swift
dependencies: [
    .package(url: "https://github.com/inappstory/ios-sdk.git", .upToNextMajor(from: "1.21.1"))
]
```
...
* `editorCellSettings` - setting the cell view of the UGC editor *<[EditorCellProtocol](https://github.com/inappstory/ios-sdk#EditorCellProtocol)>*;
